...
\begin{frame}{Long-Term Consequences}
  ...
  V(s)
  \;\approx\;
  \text{future reward from this state}
  \]
  ...
  Q(s,a)
  \;\approx\;
  \text{future reward after taking action } a
  \]
...
\begin{frame}{Using Advantage to Weight Data}
  ...
  \small
  \begin{itemize}
    \item positive advantage: this logged action was better than usual
    \item negative advantage: this logged action was worse than usual
  \end{itemize}
  ...
  \note{This slide introduces advantage as a way to turn long-term value predictions into supervised-learning weights. The exponential weighting maps positive advantages to large weights and negative advantages to small weights. The objective is behavior cloning with a weighted MSE loss. Defer value estimation until later algorithms; for now the audience only needs the idea that V and Q provide long-term scores.}
\end{frame}
